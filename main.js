...
function initLangToggle() {
  ...
  const en = {
    ...
    'proof.paper1.meta': 'Zenodo — Cognitive exoskeletons as external structure determining LLM output identity',
    'proof.paper2.meta': 'Zenodo — Executable frameworks for creative emergence and strategic foresight',
